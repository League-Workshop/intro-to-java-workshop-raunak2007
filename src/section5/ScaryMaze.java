...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		troll= ImageIO.read(getClass().getResource("trollface.jpg"));
		//3. Set the mouse pointer to the start of your maze using:
		new Robot().mouseMove(103, 88);
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("244417__lennyboy__scaryviolins.ogg"));
		sound.play();
