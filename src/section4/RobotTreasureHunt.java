...
public class RobotTreasureHunt implements KeyEventDispatcher{
	...
	private void spaceBarWasPressed() {
		...
		int robotXLocation = jazz.getX();
		int robotYLocation = jazz.getY();
		...
		if(robotXLocation==725&&robotYLocation==405) {
			JOptionPane.showMessageDialog(null,"Now go to the pirate robot");
		}
		if(robotXLocation==580&&robotYLocation==325) {
